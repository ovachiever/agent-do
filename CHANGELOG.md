...
- implicit `agent-do coord` session-start presence refresh, plus an active-peer nudge only when another agent is already active in the same project mailbox.
