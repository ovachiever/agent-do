#!/usr/bin/env python3
"""
Create Stream Deck XL profile for Droid/Factory skills.
...
def main():
    ...
    config_file = script_dir / "droid-skills.yaml"
    ...
    for cat in config['categories']:
        ...
        for skill in cat.get('skills', []):
            all_skills.append({'name': skill, 'color': color, 'category': cat_name})

    print(f"Total Droid skills: {len(all_skills)}")
